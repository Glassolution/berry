...
import { View, Text, StyleSheet, Pressable, Dimensions, StatusBar, Animated } from 'react-native';
  ...
  const handleCapture = () => {
    ...
    Animated.sequence([
      ...
      Animated.delay(50),
        ...
        router.push('/QuizScanResultScreen');
        // Reset flash opacity after navigation
        setTimeout(() => {
