...
export default function FloatingNav({ active }: { active?: 'index' | 'meals' | 'recipes' | 'progress' }) {
    ...
    <View style={styles.wrapper}>
      <View style={styles.bar}>
        ...
        <Link href="/meals" asChild>
          <Pressable style={styles.item}>
            <IconSymbol size={22} color={isActive('meals') ? colors.primary : '#9ca3af'} name={'fork.knife' as any} />
            <ThemedText style={StyleSheet.flatten([styles.label, isActive('meals') ? styles.labelActive : styles.labelInactive])}>Refeições</ThemedText>
          </Pressable>
        </Link>
        ...
        <Link href="/progress" asChild>
          <Pressable style={styles.item}>
            <IconSymbol size={22} color={isActive('progress') ? colors.primary : '#9ca3af'} name={'chart.bar.fill' as any} />
            <ThemedText style={StyleSheet.flatten([styles.label, isActive('progress') ? styles.labelActive : styles.labelInactive])}>Progresso</ThemedText>
          </Pressable>
        </Link>
      </View>
